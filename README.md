...
A standalone Mindustry cheat mod with compact 1x1 Chrono blocks for global logistics, item conversion, repair, construction, core placement, overdrive, and unit status control.
...
- **Chrono Unloader**: pulls a selected item from linked buildings globally and outputs it to adjacent conveyors.
...
- **Chrono Item Converter**: converts a selected input item into a selected output item using rarity-based ratios and power draw.
...
- **Chrono Build Tower**: rebuilds structures and assists construction globally.
...
- Global range with no distance limit.
- Tap-to-link configuration.
- Auto-connect buttons for common building categories.
